...
import com.allianzservice.insuranceproductservice.controller.TravelCompanionBackendController;
	...
	public ProductInfoVO getProductInfo(String productName) throws JsonSyntaxException, JSONException {
		...
		for (Area area : areaList) {
			...
			if (area.getName().contains("Selektors")) {
				logger.info("list of compref count-->" + area.getCompRefs().size());
				List<CompRefs> compRefList = area.getCompRefs();
