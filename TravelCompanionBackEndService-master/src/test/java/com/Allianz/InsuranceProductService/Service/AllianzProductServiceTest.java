...
public class AllianzProductServiceTest {
	...
	public void testGetProductInfo() throws Exception {
		...
		household Household = new household("1","eclass","4","role","4","5", new String[]{"member1","member2"});
		...
		//JSONObject jsonObject = new JSONObject("{ \"prodref\":\"A.Product.PO.GDF."+SkiingSlector+"Selektor\"}");
	...
	public void testContractPartiesSearch() {
		...
		household Household = new household("1","eclass","4","role","4","5", new String[]{"member1","member2"});
		contractPartiesSearch contractPartiesSearch = new contractPartiesSearch("lead", "self", "eClass", "gender", "lastName", "firstName", "partySign", "dateOfBirth", "nationality", "martialStatus", "accountManager", "policyHolderType", "preferredLanguage", "accountManagerNumber", "preferredPaymentMethod", "preferPaperlessCommunication", Household);
		assertNotNull(contractPartiesSearch.getAccountManager()+contractPartiesSearch.getAccountManagerNumber()+contractPartiesSearch.getDateOfBirth()+contractPartiesSearch.geteClass()+contractPartiesSearch.getFirstName()+contractPartiesSearch.getGender()+contractPartiesSearch.getLastName()+contractPartiesSearch.getLead()+contractPartiesSearch.getMaritalStatus()+contractPartiesSearch.getNationality()+contractPartiesSearch.getPartySign()+contractPartiesSearch.getPolicyHolderType()+contractPartiesSearch.getPreferPaperlessCommunication()+contractPartiesSearch.getPreferredLanguage()+contractPartiesSearch.getPreferredPaymentMethod()+contractPartiesSearch.getSelf()+contractPartiesSearch.getClass()+contractPartiesSearch.getHousehold());
